...
HEROINES = [
    ...
    dict(
        ...
        # 조원은 등을 보이게 한다 — 얼굴이 나오면 시선이 분산되고, 도트로만
        # 존재하는 조연들의 얼굴을 여기서 정해버리게 된다.
        climax=block("""
            뒤쪽 책상에 조원 서넛이 모여 무언가를 정하고 있음,
            그 무리에서 두세 걸음 떨어져 혼자 서 있음, 아무도 이쪽을 보지 않음,
