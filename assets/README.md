...
└─ ui/           4    logo · intro_blank · intro_small · intro_large
```
...
**지금 씬에 걸려 있는 건 `indoor/jungle_stage.png`(D12 수료식) 하나뿐입니다.** 나머지 열여섯은 **타일과 스틸을 그릴 때 구조를 참고한 자료**이고, 캠퍼스 안은 게임에서 타일맵으로 나옵니다.
