...
| **참조 이미지** | **장윤정 평상복 몸통 확정본** |
| **선행 조건** | B05 확정 |
| **자르기** | `python tools/cut_sheet.py sheet_yunjung_face.png out/yunjung --cols 3 --rows 2 --dekey 00b140 --tol 40 --trim --names normal,happy,shy,sad,surprise,angry` |

> 기본 셀이 밝으면 **작업 모드와의 낙차가 죽습니다.** 기본은 웃지 않습니다.
...
neutral cell should be unsmiling
```
