...
| **참조 이미지** | **장윤호 평상복 몸통 확정본** |
| **선행 조건** | B11 확정 |
| **자르기** | `python tools/cut_sheet.py sheet_yunho_face.png out/yunho --cols 3 --rows 2 --dekey 00b140 --tol 40 --trim --names normal,happy,shy,sad,surprise,angry` |

> 같은 강아지상인데 **윤정보다 덜 움직입니다.** 진폭을 좁게.
...
gentle, narrower range than yunjung
```
