...
>
> **정본이 못박은 것** (`CHARACTERS.md` · `GAME_DESIGN.md` · `ART_BRIEF.md` 5절 종합) — 과묵하고 표현이 없음. 조용한 실력자. 3~5자 단답. 성별이 중성적으로 확정
>
...
short straight black bob, androgynous silhouette, oversized plain black tee, dark grey wide pants, black sneakers,
