...
>
> **정본이 못박은 것** (`CHARACTERS.md` · `GAME_DESIGN.md` · `ART_BRIEF.md` 5절 종합) — 도윤과 동일 설정. 성별만 다름
>
> **비어 있는 것** — 외형 전부 — 도윤과 별개로 정해진 것이 없습니다
>
...
shoulder-length dark brown hair, plain grey zip-up hoodie over a white tee, dark navy pants, white sneakers,
