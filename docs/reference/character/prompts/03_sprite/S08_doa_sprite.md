...
|---|---|
| **파일명** | `sprite_doa.png` |
| **인물** | 여 22 · 컴퓨터공학 3학년 · 주인공 여자판 |
| **시트** | 1024 × 1024 정사각 · 4열 × 4행 = 16셀 |
| **컷** | 48 × 48px · 행 아래→왼쪽→오른쪽→위 · 열 정지·걷기1·2·3 |
| **참조 이미지** | **S01(김민아) 도트 시트 확정본** — 화풍 기준 |
| **선행 조건** | S01 확정 |
| **명찰** | 검은 랜야드 + 밝은 ID 카드 — **전 컷 착용** |
| **자르기** | `python tools/cut_sheet.py sheet_doa_sprite.png out/doa --cols 4 --rows 4 --resize 48x48 --dekey 00b140 --tol 40 --names down_idle,down_w1,down_w2,down_w3,left_idle,left_w1,left_w2,left_w3,right_idle,right_w1,right_w2,right_w3,up_idle,up_w1,up_w2,up_w3` |

> 도윤과 **복장은 완전히 같고 머리만 다릅니다.** 무채색인 이유도 같습니다.
...
shoulder-length hair tied back in one, grey zip-up hoodie, black pants, white sneakers, entirely desaturated greyscale outfit,
