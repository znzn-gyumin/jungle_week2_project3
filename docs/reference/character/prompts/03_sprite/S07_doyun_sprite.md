...
>
> **정본이 못박은 것** (`CHARACTERS.md` · `GAME_DESIGN.md` · `ART_BRIEF.md` 5절 종합) — 1인칭이라 얼굴이 화면에 안 나옴. 무난하게. 이름은 플레이어가 바꿉니다
>
> **비어 있는 것** — 머리 길이·색, 눈, 체형, 키, 복장 전부, 테마 컬러
>
...
short dark brown hair, plain grey zip-up hoodie over a white tee, dark navy pants, white sneakers,
