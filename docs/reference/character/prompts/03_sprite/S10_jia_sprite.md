...
>
> **정본이 못박은 것** (`CHARACTERS.md` · `GAME_DESIGN.md` · `ART_BRIEF.md` 5절 종합) — 성별만 다르고 말투는 동일
>
> **비어 있는 것** — 외형 전부 — 지오와 구분되는 지시가 없습니다
>
...
light brown hair in a short ponytail, bright orange graphic tee under an open blue check shirt, beige shorts, colorful sneakers,
