...
| **선행 조건** | S01 확정 (화풍 기준) |
| **자르기** | `python tools/cut_sheet.py sheet_seungmin_sprite.png out/seungmin --cols 4 --rows 4 --resize 48x48 --dekey ffffff --names down_idle,down_w1,down_w2,down_w3,left_idle,left_w1,left_w2,left_w3,right_idle,right_w1,right_w2,right_w3,up_idle,up_w1,up_w2,up_w3` |
