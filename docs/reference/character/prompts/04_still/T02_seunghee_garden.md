# T02 · 이승희 스틸 ① D7 새벽 커넥트가든 → 여명

| | |
|---|---|
| **파일명** | `cg_seunghee_still_garden.png` |
...
holding out a sketchbook as if it was taken from her, embarrassed, pages showing only the backs of people,
