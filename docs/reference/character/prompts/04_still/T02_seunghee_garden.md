...
`refs/ref_*.png` 는 세로(0.729)라 **가로 스틸에 넣으면 비율까지 끌려갑니다.**
    ...
    보조 참고로 `community_lounge_1.jpg` 도 함께 넣으세요 — 4F 라운지에서 시작해 가든으로 내려오는 씬입니다.
...
스케치북을 뺏기듯 내밀고 있음, 부끄러워함, 펼쳐진 페이지엔 사람들의 뒷모습만 그려져 있음.
